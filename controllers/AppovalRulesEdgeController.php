...
use app\models\ApprovalRulesEdgeSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * AppovalRulesEdgeController implements the CRUD actions for ApprovalRulesEdge model.
 */
class AppovalRulesEdgeController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $searchModel = new ApprovalRulesEdgeSearch();
